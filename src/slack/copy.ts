...
수고많으셨습니다! :muscle:`,
  ...
  midday: {
    title: `:hourglass_flowing_sand: *일일 업무현황 중간 보고 시간이에요.*`,
    question: `해내기로 한 일들은 잘 진행되고 있나요?`,
    prompt:
      `끝낸 것이 있으면 한 줄에 하나씩 적어 주세요. 적어 주신 대로 완료 처리해 드립니다.\n` +
      `아직이면 답하지 않으셔도 됩니다 — 저녁 회고가 시작되면 알아서 닫힙니다.`,
    noPlan: `오늘 등록된 할 일이 없습니다. \`/checkin\` 으로 지금이라도 정해 보실까요?`,
    applied: `현황을 갱신했습니다.`,
    nothingMatched: `끝낸 것으로 처리할 항목을 못 찾았습니다. 적어 주신 그대로 완료 기록에 넣었습니다.`,
  },
...
\`/done <내용>\` 방금 끝낸 일 기록
\`/plan\` 오늘 할 일 보기
\`/progress\` 오후 중간 점검 — 현황 보고 갱신 (\`중간보고\` 라고 적어도 됩니다)
\`/milestone\` 마일스톤 만들기·진행도
\`/report [기간]\` 업무보고 — 오늘·주간·월간·지난주·지난달·\`2026-09-01~09-10\`·\`30일\`
\`/history [기간]\` 날짜별 한 줄 요약으로 훑어보기
   뒤에 \`공유\` 를 붙이면 채널에, \`파일\` 을 붙이면 파일로
\`/streak\` 연속 기록
